package com.admin.solr.model;

/**
 * Solr属性
 * @author LiZhiXian
 * @version 1.0
 * @date 2015-9-11 下午5:23:41
 */
public class SolrProperty {
	...
	public String getAdd_prov() {
		return add_prov;
	}
	public void setAdd_prov(String add_prov) {
		this.add_prov = add_prov;
	}
	...
	public void setIpv15(String ipv15) {
		this.ipv15 = ipv15;
	}  
